const myProjects = [
  {
    ...
    description:
      "The application allows the user view products in the online store, sort\n" +
  ...
  },
  {
    title: "Movies App",
    description:
      "Implementation of a page with a list of movies, the possibility of a sweater dark/light style theme, requests are executed on the server.\n" +
      "Pagination is done.\n" +
