  ...
  return (
    <div>
      ...
      <div className={`${style.profileText} ${style.whiteText}`}>
        I have finished IT courses. I consider my self a responsible and orderly
        person, ready to always check my own strength and realize ambitions. I
        am looking forward for my first work experience.
      </div>
    </div>
  );
};
